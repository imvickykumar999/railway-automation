...
class RailwayDeploymentAdmin(admin.ModelAdmin):
    list_display = ['project_name', 'user', 'docker_image', 'railway_project_id', 'is_active', 'created_at']
    list_filter = ['is_active', 'created_at', 'user']
    search_fields = ['project_name', 'docker_image', 'railway_project_id', 'user__username']
